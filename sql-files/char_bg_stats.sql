...
DROP TABLE IF EXISTS `char_bg_stats`;

CREATE TABLE `char_bg_stats` (
  `char_id` INT(11) NOT NULL,
  `best_damage` INT(11) NOT NULL DEFAULT '0',
  `total_damage_done` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `total_damage_received` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `ranked_points` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `ranked_games` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `ru_captures` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `ru_wins` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `ru_lost` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `ru_skulls` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`char_id`)
